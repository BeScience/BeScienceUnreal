...
std::vector<BSU_Blaze::PalmDetection> BSU_Blaze::PredictPalmDetections(cv::Mat& img)
{
    std::vector<BSU_Blaze::PalmDetection> beforeNMSResults;
    std::vector<BSU_Blaze::PalmDetection> afterNMSResults;
...
BSU_Blaze::PalmDetection BSU_Blaze::GetPalmDetection(cv::Mat regressor, cv::Mat classificator,
    int stride, int anchor_count, int column, int row, int anchor, int offset) {

    BSU_Blaze::PalmDetection res;
...
float BSU_Blaze::sigmoid(float x) {
    return 1 / (1 + exp(-x));
}


std::vector<BSU_Blaze::PalmDetection> BSU_Blaze::DenormalizePalmDetections(std::vector<BSU_Blaze::PalmDetection> detections, int width, int height, cv::Scalar pad)
{

    std::vector<BSU_Blaze::PalmDetection> denormDets;
    ...
    {
        BSU_Blaze::PalmDetection denormDet;
...
void BSU_Blaze::DrawPalmDetections(cv::Mat& img, std::vector<BSU_Blaze::PalmDetection> denormDets)
{
...
void BSU_Blaze::DrawDetsInfo(cv::Mat& img, std::vector<BSU_Blaze::PalmDetection> filteredDets, std::vector<BSU_Blaze::PalmDetection> normDets, std::vector<BSU_Blaze::PalmDetection> denormDets)
{
...
std::vector<BSU_Blaze::PalmDetection> BSU_Blaze::FilteringDets(std::vector<BSU_Blaze::PalmDetection> detections, int width, int height)
{
    std::vector<BSU_Blaze::PalmDetection> filteredDets;
