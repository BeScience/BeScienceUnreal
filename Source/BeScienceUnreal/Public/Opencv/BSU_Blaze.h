 ...
 * 
 */
class BESCIENCEUNREAL_API BSU_Blaze
{
public:
	BSU_Blaze();
	~BSU_Blaze();
	...
	void DrawPalmDetections(cv::Mat& img, std::vector<BSU_Blaze::PalmDetection> denormDets);
	void DrawDetsInfo(cv::Mat& img, std::vector<BSU_Blaze::PalmDetection> filteredDets, std::vector<BSU_Blaze::PalmDetection> normDets, std::vector<BSU_Blaze::PalmDetection> denormDets);
